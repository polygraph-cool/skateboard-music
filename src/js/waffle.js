...
var WaffleChart = function() {
  ...
  function drawWaffleChart(_obj) {
    ...
    var legend = d3v3.select($_selector)
      .append("div")
      .attr("class", "legend");
    ...
    if (_obj.rounded) {
      legendIcon.style("border-radius", "50%"); // circles
    }
    ...
    var svg = d3v3.select(_obj.selector)
      .append("svg")
      .attr("class", "waffle")
      .attr("width", width)
      .attr("height", height);
